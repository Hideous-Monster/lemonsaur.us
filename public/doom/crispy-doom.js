...
wasmBinaryFile = "tesla-doom.wasm";
...
function getHostByName(name) {
 ...
 SAFE_HEAP_STORE(addrListBuf + 8 | 0, inetPton4(DNS.lookup_name(name)) | 0, 4);
...
var _I_ShutdownJoystick = Module["_I_ShutdownJoystick"] = function() {
 return (_I_ShutdownJoystick = Module["_I_ShutdownJoystick"] = Module["asm"]["I_ShutdownJoystick"]).apply(null, arguments);
};

var _I_InitJoystick = Module["_I_InitJoystick"] = function() {
 return (_I_InitJoystick = Module["_I_InitJoystick"] = Module["asm"]["I_InitJoystick"]).apply(null, arguments);
};

var _UpdateJoystick = Module["_UpdateJoystick"] = function() {
 return (_UpdateJoystick = Module["_UpdateJoystick"] = Module["asm"]["UpdateJoystick"]).apply(null, arguments);
};
