...
const ROASTS: Record<string, string> = {
	...
	grep: "GREP: PATTERN NOT FOUND. JUST LIKE YOUR SEARCH HISTORY.",
	...
	apt: "E: UNABLE TO LOCATE PACKAGE 'REALITY-CHECK'",
	brew: "ERROR: HOMEBREW IS NOT A REAL BREWERY.",
	npm: "NPM ERR! 404 NOT FOUND: REAL-TERMINAL@LATEST",
	pip: "COULD NOT FIND A VERSION THAT SATISFIES YOUR EXPECTATIONS.",
	pacman: "WAKA WAKA WAKA... WRONG PACMAN.",
	paru: "PARU: ERROR: TARGET NOT FOUND: ACTUAL-LINUX-SYSTEM",
	yay: "YAY! ...IS WHAT YOU WON'T BE SAYING. THIS ISN'T ARCH.",
	dnf: "DNF: DID NOT FIND. ANYTHING. BECAUSE THIS IS FAKE.",
	yum: "YUM! DELICIOUS FAILURE.",
	zypper: "ZYPPER? I BARELY KNOW HER!",
	top: "TOP PROCESS: LEMONSAURUS.EXE (100% CPU, 100% VIBES)",
	...
	vim: "YOU'VE OPENED VIM. YOU MAY NEVER LEAVE. JUST LIKE REAL LIFE.",
	vi: "YOU'VE OPENED VI. TYPE :Q! TO... WAIT, THAT WON'T WORK HERE EITHER.",
	emacs: "EMACS: THE OPERATING SYSTEM THAT LACKS A GOOD TEXT EDITOR.",
